...
insert into desk(sit_num) values (1);
insert into desk(sit_num) values (2);
insert into desk(sit_num) values (3);

insert into employee(name, desk) values ('петя', 1);
insert into employee(name, desk) values ('ваня', 2);
insert into employee(name, desk) values ('степа', 3);
